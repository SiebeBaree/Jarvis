...
# Injecting secrets
- This project does not use a .env file, never create one.
- When using a command that needs secrets you can use "ek run -- <command>" to inject secrets on the fly.

## Package Managers
- Use pnpm if the project already uses it, otherwise use bun.
- Never use npm or yarn.

## Tech Stack Preferences (webapps)
...
- Packages: TailwindCSS, Zod, Tanstack Query/Table, Drizzle, Axios
...
- Bulk/mechanical work (clear-spec implementation, data analysis, migrations): opus-4.8
